# -*- coding: utf-8 -*-
#
# Dataserver documentation build configuration file, created by
...
project = u'Course Contenttypes'
copyright = u'2011--2012, NTI'
...
htmlhelp_basename = 'CourseContent'
...
latex_documents = [
  ('index', 'Dataserver.tex', u'Dataserver Documentation',
   u'NTI', 'manual'),
]
...
man_pages = [
    ('index', 'dataserver', u'Dataserver Documentation',
     [u'NTI'], 1)
]
