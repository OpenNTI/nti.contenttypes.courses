...
class TestFunctionalEnrollment(CourseLayerTest):
    ...
    def _shared_setup(self):
        ...
        for name in u'course', u'course2':
        ...
        self.course = admin[u'course']
        self.course2 = admin[u'course2']

        course = self.course
        self.section = course.SubInstances[u'section1'] = courses.ContentCourseSubInstance()

    def _do_test_add_drop(self, principal, course,
                          enroll_scope=u'Public',
    ...
    def test_enrollment_map_initial_enrollment(self):
        ...
        self._do_test_add_drop(self.principal, self.course,
                               enroll_scope=u'ForCreditNonDegree',
