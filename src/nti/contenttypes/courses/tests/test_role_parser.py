...
class TestRoleParser(CourseLayerTest):
    ...
    def setup_users(self):
        unames = (u'jmadden', u'steve.johnson@nextthought.com', u'harp4162',
                  u'orig_instructor', u'course_editor_name')
        users = {}
        for uname in unames:
    ...
    def test_parse(self):
        ...
        # orig_instructor still has access/is-instructor even though not in
        # roles file.
